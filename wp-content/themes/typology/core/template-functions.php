...
if ( !function_exists( 'typology_get_social_share' ) ):
    function typology_get_social_share() {
        ...
        $title = typology_esc_text( get_the_title() );
        $url = typology_esc_url( get_the_permalink() );

        $share = array();
        $share['facebook'] = '<a href="javascript:void(0);" class="typology-facebook typology-share-item hover-on" data-url="http://www.facebook.com/sharer/sharer.php?u=' . $url . '&amp;t=' .$title . '"><i class="fa fa-facebook"></i></a>';
        $share['twitter'] = '<a href="javascript:void(0);" class="typology-twitter typology-share-item hover-on" data-url="http://twitter.com/intent/tweet?url=' . $url . '&amp;text=' .$title . '"><i class="fa fa-twitter"></i></a>';
        $share['gplus'] = '<a href="javascript:void(0);"  class="typology-gplus typology-share-item hover-on" data-url="https://plus.google.com/share?url=' . $url . '"><i class="fa fa-google-plus"></i></a>';
        $pin_img = has_post_thumbnail() ? wp_get_attachment_image_src( get_post_thumbnail_id(), 'full' ) : '';
        $pin_img = isset( $pin_img[0] ) ? $pin_img[0] : '';
        $share['pinterest'] = '<a href="javascript:void(0);"  class="typology-pinterest typology-share-item hover-on" data-url="http://pinterest.com/pin/create/button/?url=' . $url . '&amp;media=' . urlencode( esc_attr( $pin_img ) ) . '&amp;description=' .$title . '"><i class="fa fa-pinterest-p"></i></a>';
        $share['linkedin'] = '<a href="javascript:void(0);"  class="typology-linkedin typology-share-item hover-on" data-url="http://www.linkedin.com/shareArticle?mini=true&amp;url=' . $url . '&amp;title=' . esc_attr( get_the_title() ) . '"><i class="fa fa-linkedin"></i></a>';
        $share['reddit'] = '<a href="javascript:void(0);"  class="typology-reddit typology-share-item hover-on" data-url="http://www.reddit.com/submit?url=' . $url . '&amp;title=' .$title . '"><i class="fa fa-reddit-alien"></i></a>';
        $share['email'] = '<a href="mailto:?subject=' .$title . '&amp;body=' . $url . '" class="typology-mailto hover-on"><i class="fa fa-envelope-o"></i></a>';
        $share['stumbleupon'] = '<a href="javascript:void(0);"  class="typology-stumbleupon typology-share-item hover-on" data-url="http://www.stumbleupon.com/badge?url=' . $url . '&amp;title=' .$title . '"><i class="fa fa-stumbleupon"></i></a>';
        $share['whatsapp'] = '<a href="https://api.whatsapp.com/send?text='.$title.' '.$url.'" class="typology-whatsapp hover-on" ><i class="fa fa-whatsapp"></i></a>';
...
if ( !function_exists( 'typology_display_media' ) ):
    function typology_display_media( $args = array() ) {
        ...
        $cover_video_fallback_image = !empty( $cover_video_fallback_image ) ? '<img class="typology-fallback-video-img" src="'.esc_url( $cover_video_fallback_image ).'" style="display:none"/>' : '';
